...
Update (04/30/17): The website is being moved to Google AppEngine so I can have more than 1 tiny model up (Heroku is quite resource-constrained). The experimental version of the site can be found [here](http://deepchatmodels.appspot.com/), but is not guaranteed bug-free!
