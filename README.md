...
* Please post any feedbacks/bugs as an issue and I will respond within 24 hours. If you've encountered any error at all trying to run the project, please let me know! I'd like it to be as headache free as possible. Speaking of headaches, please use 1.0 <= tensorflow version <= 1.1. The recent 1.2 release (changes [here](https://github.com/tensorflow/tensorflow/blob/master/RELEASE.md)) took quite a blow at the RNN libraries. I'm working on it, but I'd also happily accept a PR that accomodates the changes (while still being backwards-compatible).
