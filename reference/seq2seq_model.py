...
class Seq2SeqModel(object):
    ...
    def __init__(self,
        ...
        print("Storing instance variables . . . ")
        ...
        if num_samples > 0 and num_samples < self.target_vocab_size:
            print("Constructing sampled softmax . . . ")
        ...
        if not forward_only:
            print("Handling not forward only . . . ")
            self.gradient_norms = []
            self.updates = []
